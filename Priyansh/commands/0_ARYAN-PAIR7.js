...
module.exports.onLoad = async() => {
    ...
    if (!existsSync(path)) await downloadFile("https://i.postimg.cc/XJMMZtGT/Messenger-creation-1187186336299018.png", path);
}
...
async function makeImage({ one, two }) {
    ...
    let pairing_img = await jimp.read(__root + "/pairing.png7");
    ...
    pairing_img.composite(circleOne.resize(205, 205), 12, 11).composite(circleTwo.resize(205, 205), 265, 10);
